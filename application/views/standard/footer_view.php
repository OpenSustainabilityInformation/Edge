...
<div id="footer">
	...
	<li><p>Free and open environmental impact data<br/>Footprinted is in beta.</p></li>
	</ul>	
	</div>
	<div class="footer-list">
	<ul>
...
<ul>  	
	...
	<li><p><a href="/about/data">Data</a></p></li>
	<li><p><a href="/about/API">API</a></p></li>
	<li><p><a href="/endpoint">SPARQL Endpoint</a></p></li>	
	<li><p><a href="https://github.com/organizations/OpenSustainabilityInformation" target="_blank">Source Code</a></p></li>
	</ul>	
	</div>
