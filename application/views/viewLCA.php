...
<body id="home">
	...
	<div id="lca_background">	
		<div id="lca_impact" class="lca">
			...
			<div id="lca_qr" class="lca">
			
			<h2>QR Code</h2>
			<img src=<?php echo"'https://chart.googleapis.com/chart?chs=200x200&amp;cht=qr&amp;chl=Hello%20world".$thispage."'" ?> alt="QRCode Image" />
			<p><i>Use this code for printing out and attaching to physical objects.</i></p>
			</div>
